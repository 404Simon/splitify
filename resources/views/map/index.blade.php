        ...
        <div class="bg-white rounded-lg shadow p-6 dark:bg-gray-800">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('groups.mapMarkers.create', $group->id) }}"
                   class="inline-flex items-center justify-center p-2 bg-green-500 hover:bg-green-700 text-white text-sm font-medium rounded-full dark:bg-green-600 dark:hover:bg-green-700 w-8 h-8">
